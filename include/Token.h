...
namespace lox {
    using TokenLiteral = std::variant<std::monostate, std::string, double, bool, std::shared_ptr<LoxCallable> >;
    ...
    struct TokenLiteralToBoolean {
        ...
        bool operator()(const std::shared_ptr<LoxCallable> &func) const { return func->call(); }
    };
